...
(this, (function (t, n, e) {
        ...
        function h(t, {
            ...
            const g = function (t, {
                ...
                n < a ? (n = a, o = Math.min(a + t, i)) : o > i && (o = i, n = Math.max(i - t, a)), {
                    min: n,
                    max: o
                }
            }
        ...
        z = {
            category: function (t, n, e) {
                ...
                let l;
                return n < -c ? (i = Math.min(i + s, o), a = 1 === r ? i : i - r, l = i === o) : n > c && (a = Math.max(0, a - s), i = 1 === r ? a : a + r, l = 0 === a),
                h(t, {
                    min: a,
                    max: i
                }, e) || l
        ...
        function W(t, n) {
            ...
            if (!o.dragStart)
                return;
            N(t, "mousemove");
            const { mode: a, onZoomComplete: i, drag: {
                threshold: c = 0,
            ...
            f = Math.sqrt(u * u + d * d);
            if (o.dragStart = o.dragEnd = null, f <= c)
                return o.dragging = !1, void t.update("none");
            Z(t, {
                x: l.left,
                y: l.top
            }, {
        ...
        function I(t, n) {
            ...
            if (!function (t, n, a) {
                if (i(o(a.wheel), n))
                    ...
                    else if (!1 !== q(t, n, a) && (n.cancelable && n.preventDefault(), void 0 !== n.deltaY))
                        return !0
                }
                    (t, n, r))return;
        ...
        function $(t, o) {
            ...
            r && r.enabled && (l.add(new n.Pan({
                        ...
                        n.delta = null,
                        n.panning && (n.panning = !1, n.filterNextClick = !0, e.callback(n.options.pan.onPanComplete, [{
                                        chart: t
                                    }
                                ]))
                    }
        ...
        function nt(t, n, e) {
            ...
            u.fillRect(r, c, s, l),
            o.borderWidth > 0 && (u.lineWidth = o.borderWidth, u.strokeStyle = o.borderColor || "rgba(225,225,225)", u.strokeRect(r, c, s, l)),
            u.restore()
        }
        var et = {
            id: "zoom",
            ...
            start: function (t, o, a) {
                ...
                t.resetZoom = n => function (t, n = "default") {
                    ...
                    e.each(t.scales, (function (t) {
                            const n = t.options;
                            a[t.id] ? (n.min = a[t.id].min.options, n.max = a[t.id].max.options) : (delete n.min, delete n.max),
            ...
            beforeUpdate: function (t, n, e) {
                ...
                function (t, n) {
                    ...
                    o.enabled ? (A(t, e, "wheel", I), U(t, "onZoomComplete", i, 250)) : N(t, "wheel"),
                    a.enabled ? (A(t, e, "mousedown", V), A(t, e.ownerDocument, "mouseup", W)) : (N(t, "mousedown"), N(t, "mousemove"), N(t, "mouseup"), N(t, "keydown"))
                }
                (t, e)
            },
