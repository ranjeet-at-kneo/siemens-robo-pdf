...
;(function() {
    ...
    ctx.prototype.setLineDash = function(segments) { this.lineDash = segments; };
    ctx.prototype.getLineDash = function() { return this.lineDash || []; };
    ...
    ctx.prototype.addEventListener = function(type, listener, options) {};
    ctx.prototype.removeEventListener = function(type, listener, options) {};
    Object.defineProperty(ctx.prototype, 'style', {
        get: function() { return this.__canvas.style; }
    });
    ctx.prototype.getAttribute = function(name) {
        return this[name] || this.__canvas.getAttribute(name);
    };
    ctx.prototype.setAttribute = function(name, value) {
        this[name] = value;
        this.__canvas.setAttribute(name, value);
    };
    ctx.prototype.getBoundingClientRect = function() {
        return {
            left: 0,
            top: 0,
            right: this.width,
    ...
    Object.defineProperty(ctx.prototype, 'tagName', {
        get: function() { return "CANVAS"; }
    });
    Object.defineProperty(ctx.prototype, 'nodeName', {
        get: function() { return "CANVAS"; }
    });
    Object.defineProperty(ctx.prototype, 'ownerDocument', {
        get: function() { return this.__document; }
    });
